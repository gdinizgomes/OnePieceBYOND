...
const GameDefinitions = {
    ...
    "char_upper_arm": { type: "part", visual: { model: "box", color: 0xFFCCAA, scale: [0.12, 0.35, 0.12] } },
    "char_lower_arm": { type: "part", visual: { model: "box", color: 0xFFCCAA, scale: [0.10, 0.30, 0.10] } },
    "char_hand": { type: "part", visual: { model: "box", color: 0xFFCCAA, scale: [0.08, 0.10, 0.10] } },
    "char_upper_leg": { type: "part", visual: { model: "box", color: 0x0000FF, scale: [0.14, 0.40, 0.14] } },
    "char_lower_leg": { type: "part", visual: { model: "box", color: 0x0000FF, scale: [0.12, 0.40, 0.12] } },
    "char_foot": { type: "part", visual: { model: "box", color: 0x333333, scale: [0.12, 0.10, 0.22] } },
    ...
    // --- ARMADURAS VISUAIS ---
    "armor_head_bandana": { id: "armor_head_bandana", type: "equipment", tags: ["head"], visual: { model: "box", color: 0xFF0000, scale: [0.32, 0.08, 0.32] }, attachment: { bone: "head", pos: [0, 0.10, 0], rot: [0, 0, 0] } },
    "armor_head_bandana_black": { id: "armor_head_bandana_black", type: "equipment", tags: ["head"], visual: { model: "box", color: 0x000000, scale: [0.32, 0.08, 0.32] }, attachment: { bone: "head", pos: [0, 0.10, 0], rot: [0, 0, 0] } },
    "armor_body_shirt": { id: "armor_body_shirt", type: "equipment", tags: ["body"], visual: { model: "box", color: 0xFFFFFF, scale: [0.36, 0.40, 0.22] }, attachment: { bone: "torso", pos: [0, 0.10, 0], rot: [0, 0, 0] } },
    ...
    "armor_feet_boots": { id: "armor_feet_boots", type: "equipment", tags: ["feet"], visual: { model: "box", color: 0x3d2b1f, scale: [0.15, 0.10, 0.24] }, attachments: [ { bone: "leftFoot", pos: [0, 0, 0], rot: [0, 0, 0] }, { bone: "rightFoot", pos: [0, 0, 0], rot: [0, 0, 0] } ] },

    // --- PROPS ---
    "prop_tree_log": { id: "prop_tree_log", type: "prop", visual: { model: "group", parts: [ { model: "cylinder", color: 0x8B4513, scale: [0.4, 1.8, 0.4], pos: [0, 0.9, 0] } ] }, physics: { solid: true, standable: true, mass: 50, shape: "cylinder", radius: 0.2 } },

    // --- SKILLS VISUAIS ---
    "vfx_fireball": { type: "vfx", visual: { model: "box", color: 0xFF4500, scale: [0.6, 0.6, 0.6] } },
